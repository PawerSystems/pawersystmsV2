...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>{{ __('customer.edit_customer') }}</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/">{{ __('keywords.home') }}</a></li>
              <li class="breadcrumb-item active">{{ __('customer.edit_customer') }}</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <div class="col-md-6" style="margin:auto; padding-top:30px;">
        <div class="card">
            <div class="card-body register-card-body">
                <p class="login-box-msg">{{ __('customer.edit_customer') }}</p>

                <form action="{{ Route('updatecustomer',session('business_name')) }}" method="post" id="saveBusiness" enctype="multipart/form-data">                    
                <input type="hidden" name="id" value="{{ $customer->id }}">
                    @csrf
                    <div class="input-group mb-3">
                        <input type="text" name="name" value="{{ $customer->name }}" class="form-control" placeholder="{{ __('customer.full_name') }}">
                    ...
                    <div class="input-group mb-3">
                        <input type="email" name="email" value="{{ $customer->email }}" class="form-control" placeholder="{{ __('keywords.email') }}">
                        <div class="input-group-append">
                            <div class="input-group-text">
                    ...
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                          ...
                          @foreach($countries as $country)
                              <option value="{{ $country->id }}" @if ($country->id == $customer->country_id)
                                selected
                              @endif>{{ $country->name }}</option>
                            @endforeach 
                          </select>
                        </div>
                        <input type="number" name="number" value="{{ $customer->number }}" class="form-control" placeholder="{{ __('keywords.number') }}">
                        <div class="input-group-append">
                            <div class="input-group-text">
                    ...
                    <div class="input-group mb-3">
                      <select name="gender" class="form-control select2">
                        <x-gender-list selected="{{ $customer->gender }}" />
                      </select>
                      <div class="input-group-append">
                        <div class="input-group-text">
                    ...
                    <div class="input-group mb-3">
                        <select name="birthYear" class="form-control select2">
                          <x-birth-years-list selected="{{ $customer->birth_year }}" />
                        </select>
                        <div class="input-group-append">
                          <div class="input-group-text">
                    ...
                    @if($cpr)
                     <div class="input-group mb-3">
                         <input type="text" name="cprnr" value="{{ $customer->cprnr }}" class="form-control" placeholder="{{ __('customer.cpnr') }}">
                         <div class="input-group-append">
                             <div class="input-group-text">
                    ...
                    @if($mdr)
                      <div class="input-group mb-3">
                          <input type="text" name="mednr" value="{{ $customer->mednr }}" class="form-control" placeholder="{{ __('customer.mednr') }}">
                          <div class="input-group-append">
                              <div class="input-group-text">
                                  <span class="fas fa-key"></span>
                              </div>
