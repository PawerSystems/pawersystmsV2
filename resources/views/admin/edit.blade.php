    ...
    <div class="col-md-6" style="margin:auto; padding-top:30px;">
        <div class="card">
            <div class="card-body register-card-body">
                <p class="login-box-msg">{{ __('users.edit_user') }}</p>

                <form action="{{ Route('updateadmin',session('business_name')) }}" method="post" id="saveBusiness" enctype="multipart/form-data">                    
                <input type="hidden" name="id" value="{{ $admin->id }}">
                    @csrf
                    <div class="input-group mb-3">
                      <label class="col-md-12" for="text">{{ __('keywords.name') }}:</label>
                        <input type="text" name="name" value="{{ $admin->name }}" class="form-control" placeholder="Full name">
                    ...
                    <div class="input-group mb-3">
                      <label class="col-md-12" for="text">{{ __('keywords.email') }}:</label>
                        <input type="email" name="email" value="{{ $admin->email }}" class="form-control" placeholder="{{ __('keywords.email') }}">
                        <div class="input-group-append">
                            <div class="input-group-text">
                    ...
                    <div class="input-group mb-3">
                      <label class="col-md-12" for="number">{{ __('keywords.number') }}:
                      </label>
                        ...
                        <input type="number" name="number" value="{{ $admin->number }}" class="form-control" placeholder="{{ __('keywords.number') }}">
                        <div class="input-group-append">
                            <div class="input-group-text">
                    ...
                    <div class="input-group mb-3">
                      <label class="col-md-12" for="role">{{ __('users.role') }}:</label>
                        <select name="role" class="form-control">
                          @foreach($roles as $role)
                          <option value="{{ $role->id }}" @if($role->id == $admin->role) selected @endif>{{ $role->title }}</option>
                          @endforeach 
                    ...
                    <div class="input-group mb-3">
                      <label class="col-md-12" for="language">{{ __('users.language') }}:</label>
                    ...
                    <div class="input-group mb-3">
                      <label for="gender" class="col-md-12 col-form-label">{{ __('profile.gender') }}</label>
                      <select name="gender" class="form-control select2">
                        <x-gender-list selected="{{ $admin->gender }}" />
                      </select>
                      <div class="input-group-append">
                        <div class="input-group-text">
                    ...
                    <div class="input-group mb-3">
                      <label for="birthYear" class="col-md-12 col-form-label">{{ __('profile.birth_year') }}</label>
                        <select name="birthYear" class="form-control select2">
                          <x-birth-years-list selected="{{ $admin->birth_year }}" />
                        </select>
                        <div class="input-group-append">
                          <div class="input-group-text">
                    ...
                    @if($cpr)
                    <div class="input-group mb-3">
                      <label class="col-md-12" for="cpr">{{ __('users.cpr') }}:</label>
                        <input type="text" name="cprnr" value="{{ $admin->cprnr }}" class="form-control" placeholder="{{ __('users.cpr') }}">
                        <div class="input-group-append">
                            <div class="input-group-text">
                    ...
                    @if($mdr)
                      <div class="input-group mb-3">
                        <label class="col-md-12" for="med">{{ __('users.med') }}:</label>
                          <input type="text" name="mednr" value="{{ $admin->mednr }}" class="form-control" placeholder="{{ __('users.med') }}">
                          <div class="input-group-append">
                              <div class="input-group-text">
                                  <span class="fas fa-key"></span>
                              </div>
                    ...
                    <div class="form-group row">
                      <label class="col-md-12" for="file">{{ __('users.profile_picture') }}:</label>
                    ...
                    <div class="form-group row">
                      <div class="col-sm-12">
                        <textarea class="form-control" name="text" id="text" value="{{ $admin->free_txt }}">{{ $admin->free_txt }}</textarea>
                      </div>  
                    </div>

                    <div class="form-group">
                      <div class="custom-control custom-checkbox">
                          <input type="checkbox" name="is_therapist" id="is_therapist" class="custom-control-input" @if($admin->is_therapist) checked @endif >
